...
MAZE_TEXT = 'platform/maps/map0{0}.jpg'
...
START_MENU_IMG = pygame.image.load('platform/img/START_MENU.png')
HELP_3PLAYER = pygame.image.load('platform/img/3player_help.png')

HELP_2PLAYER = pygame.image.load('platform/img/2player_help.png')

IMG_TANK1 = pygame.image.load('platform/img/tank1.png')
IMG_TANK2 = pygame.image.load('platform/img/tank2.png')
IMG_TANK3 = pygame.image.load('platform/img/tank3.png')

SCORE_FRAME_2player = pygame.image.load('platform/img/score_frame_2player.png')
SCORE_FRAME_3player = pygame.image.load('platform/img/score_frame_3player.png')

IMG_EXPLOSION = pygame.image.load('platform/img/explosion/explosion.png')

###############
# Game Musics #
###############

EXPLOSION_SOUND = 'platform/musics/explosion.mp3'
